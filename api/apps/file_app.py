...
@manager.route('/root_folder', methods=['GET'])  # type: ignore # noqa: F821
@login_required
def get_root_folder():
    try:
        root_folder = FileService.get_root_folder(current_user.id)
...
@manager.route('/parent_folder', methods=['GET'])  # type: ignore # noqa: F821
@login_required
...
@manager.route('/all_parent_folder', methods=['GET'])  # type: ignore # noqa: F821
@login_required
...
@manager.route('/get/<file_id>', methods=['GET'])  # type: ignore # noqa: F821
@login_required
def get(file_id):
    try:
        e, file = FileService.get_by_id(file_id)
...
@manager.route('/mv', methods=['POST'])  # type: ignore # noqa: F821
@login_required
