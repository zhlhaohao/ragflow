...
def init_settings():
    ...
    PARSERS = LLM.get(
        "parsers",
        "naive:General,omni:Omni,qa:Q&A,resume:Resume,manual:Manual,table:Table,paper:Paper,book:Book,laws:Laws,presentation:Presentation,picture:Picture,one:One,audio:Audio,knowledge_graph:Knowledge Graph,email:Email,tag:Tag")
