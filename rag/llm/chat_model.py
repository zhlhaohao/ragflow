...
class Base(ABC):
    ...
    def __init__(self, key, model_name, base_url):
        ...
        # 获取环境变量 OPENAI_PROXY
        if os.environ.get("OPENAI_PROXY") and 'host.docker.internal' not in base_url and 'localhost' not in base_url and not is_ip_address(extract_ip_from_url(base_url)):
